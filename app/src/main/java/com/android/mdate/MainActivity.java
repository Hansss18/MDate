...
public class MainActivity extends AppCompatActivity {
    ...
    public void getData(){
        ...
        AndroidNetworking
                .get("http://spiwin.epizy.com/getData.php")
                .setTag("Get Data")
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try{ Boolean status = response.getBoolean("status");
                            if(status){
                                ...
                                recycleViewAdapter = new RecyclerViewAdapter(MainActivity.this, array_nim,array_nama,array_alamat,array_hobi);
